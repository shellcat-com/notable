...
final class HistoryStore: ObservableObject {
    ...
    init(fileManager: FileManager = .default) {
        ...
        rootURL = appSupport
            .appendingPathComponent("io.notable.Notable", isDirectory: true)
    ...
    func createDocument(for capture: Capture) -> UUID? {
        ...
        do {
            ...
            NSLog("Notable: could not create local history entry — \(error)")
            return nil
        }
    }
    ...
    func save(_ document: CaptureDocument) {
        do {
            ...
            NSLog("Notable: could not save local history entry — \(error)")
        }
    }
    ...
    func restore(_ id: UUID) -> RestoredCaptureDocument? {
        do {
            ...
            NSLog("Notable: could not restore local history entry — \(error)")
            return nil
        }
    }
    ...
    func remove(_ id: UUID) {
        do {
            ...
            NSLog("Notable: could not remove local history entry — \(error)")
        }
    }
    ...
    private func createRootIfNeeded() {
        do {
            ...
            NSLog("Notable: could not create history directory — \(error)")
        }
    }
    ...
    private func loadIndex() {
        ...
        do {
            ...
            NSLog("Notable: could not read local history index — \(error)")
        }
    }
    ...
    private func writeIndex() {
        do {
            ...
            NSLog("Notable: could not write local history index — \(error)")
        }
    }
...
final class BrandKitStore: ObservableObject {
    ...
    private let defaultsKey = "io.notable.brandKits"
