...
export function PrivacySection() {
  ...
  return (
    <section id="privacy" className="border-b bg-muted/20">
      <div className="mx-auto max-w-6xl px-4 py-16 md:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <SectionHeader
              kicker="Privacy"
              title="Your pixels stay on your Mac."
          ...
          >
            ...
            <div className="space-y-4 p-6">
              <div className="flex items-center justify-between rounded-xl border bg-background p-4">
                ...
                <span className="rounded-full bg-emerald-500/15 px-3 py-1 font-mono text-xs text-emerald-500">
                  Granted
                </span>
              </div>
              <div className="flex items-center justify-between rounded-xl border bg-background p-4 opacity-60">
                <div>
